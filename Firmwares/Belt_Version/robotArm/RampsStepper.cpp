...
RampsStepper::RampsStepper(int aStepPin, int aDirPin, int aEnablePin) {
  //setReductionRatio(1, 3200); // Origional
  setReductionRatio(3.55556, 3200); // 1 replaced by 3.55556 as discussed here: https://www.facebook.com/20sffactory/posts/2012672548768184?comment_id=2022608394441266&reply_comment_id=2023240877711351
  stepPin = aStepPin;
  dirPin = aDirPin;
