...
void setup() {
  ...
  //Reduction of steppers.. For Teeth Version Gears  
...
//  stepperRotate.setReductionRatio(32.0 / 9.0, 200 *16);
  ...
  // Redcution For Belt Version (GT2 Belt with GT2 Pulley)
  stepperHigher.setReductionRatio(90.0 / 20.0, 200 *16);  //Big Gear: 90 teeth, Small Gear (GT2 Pulley): 20 teeth, steps per rev: 200, microsteps: 16
  stepperLower.setReductionRatio(90.0 / 20.0, 200 *16);   //Big Gear: 90 teeth, Small Gear (GT2 Pulley): 20 teeth, steps per rev: 200, microsteps: 16
  stepperRotate.setReductionRatio(90.0 / 20.0, 200 *16);  //Big Gear: 90 teeth, Small Gear (GT2 Pulley): 20 teeth, steps per rev: 200, microsteps: 16
